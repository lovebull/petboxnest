...
export const metadata: Metadata = {
  title: "Refund Policy | Larumsport",
  description:
    "Learn about Larumsport's 30-day return window, item eligibility, return process, exchanges, and refund timing.",
}
...
export default function RefundPolicyPage() {
  return (
    <StaticPageShell
      ...
      intro="We want every Larumsport product to feel right. "
    ...
    >
      ...
      <PolicySection title="Return eligibility">
        <BulletList>
          ...
          <li>Product Concerns: If you believe you have received a defective or incorrect item, please contact our customer service team immediately at support@larumsport.com. We will do our best to address and resolve any issues.</li>
          ...
          <li>Proof of purchase from Larumsport is required.</li> */}
        </BulletList>
        {/* <p>
      ...
      {/* <PolicySection title="How to make a return">
        <ol className="space-y-5">
          <li><strong className="text-ui-fg-base">1. Contact us.</strong> Email support@larumsport.com with your order number and the item you want to return.</li>
      ...
      <PolicySection title="Amazon purchases">
        ...
        <PolicySection title="   ">
        <p>
          By making a purchase on larumsport, you acknowledge and agree to our return policy. We thank you for your understanding and look forward to serving your badminton needs.
        </p>
      </PolicySection>
    </StaticPageShell>
  )
