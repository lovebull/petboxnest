    ...
    >
      <PolicySection title="What is covered">
        <p>
          ...
          prevent a product from performing as reasonably intended under
          normal use.
        </p>
      </PolicySection>
      ...
      <PolicySection title="What is not covered">
        <BulletList>
          ...
          <li>Damage caused by impact, misuse, neglect, or improper storage.</li>
          <li>Unauthorized repair, alteration, or use outside the product's intended purpose.</li>
          <li>Items purchased from an unauthorized seller or without proof of purchase.</li>
