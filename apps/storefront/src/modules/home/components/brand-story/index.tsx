          ...
          <div className="flex items-center px-2 py-10 small:px-8 small:py-14 medium:px-0 medium:py-16 medium:pr-16 large:pr-24">
            <div className="max-w-[500px]">
              ...
              <div className="mt-6 space-y-5 text-[15px] leading-7 text-[#302e2a]">
                ...
                <p>
                  Maybe you&apos;re new to a sport and still finding your
                  people. Maybe you&apos;re a young parent who found a sport
                  that finally fits your life. Maybe you&apos;re the one who
                  books the courts and makes Saturday happen.
                </p>
                <p>
                  Whoever you are — you care about the details. You buy the good
                  coffee. You notice when something&apos;s well-made.
                </p>
                <p>
